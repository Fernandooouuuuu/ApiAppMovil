...
import com.SneakerVibe.boleta.model.Carrito;
import com.SneakerVibe.boleta.repository.CarritoRepository;
...
public class CarritoController {
    ...
    public Carrito updateCarrito(@PathVariable Long id, @RequestBody Carrito carrito) {
        ...
        existingCarrito.setUsuarioId(carrito.getUsuarioId());
