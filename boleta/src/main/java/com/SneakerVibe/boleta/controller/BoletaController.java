package com.SneakerVibe.boleta.controller;

import org.springframework.web.bind.annotation.*;
import java.util.List;

import com.SneakerVibe.boleta.model.Boleta;
import com.SneakerVibe.boleta.repository.BoletaRepository;
...
public class BoletaController {
    ...
    public Boleta updateBoleta(@PathVariable Long id, @RequestBody Boleta boletaDetails) {
        ...
        boleta.setFechaEmision(boletaDetails.getFechaEmision());
        boleta.setIdUsuario(boletaDetails.getIdUsuario());
        boleta.setItems(boletaDetails.getItems());
        boleta.setHash(boletaDetails.getHash());
